...
// alef:hash:5ed4b99b742287119211e8e70393068fabf54d95228a266c7161530328bf99a6
...
public struct StreamChoice: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.delta = try container.decodeIfPresent(StreamDelta.self, forKey: .delta) ?? StreamDelta()
