...
# alef:hash:80b67873078f05f0911f5d96fe789f954ffc15b717e2eaf12cb3486d256695f1
  ...
  def defaultclient_chat_async(obj, req) do
    obj =
      case obj do
        ...
        %LiterLlm.DefaultClient{ref: reference} when is_reference(reference) -> reference
        _ -> raise ArgumentError, "receiver must be a reference or LiterLlm.DefaultClient wrapper"
      end
