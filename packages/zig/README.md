...
<!-- alef:hash:90a71d3cfea962e4f49799c3c941253c41b0b05e132567aaee2523abc14b7588 -->
...
```bash
zig fetch --save https://github.com/xberg-io/liter-llm/archive/refs/tags/v2.0.0.tar.gz
```
