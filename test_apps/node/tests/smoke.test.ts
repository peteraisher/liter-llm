...
// alef:hash:2e9e1cd02bae3af344d158586062b668dff693ace69bb248a2e342af867c9970
...
describe("smoke", () => {
    ...
    const client = createClient(apiKey ?? 'test-key', baseUrl);
		const stream = await client.chatStream({ maxTokens: 50, messages: [{ role: "user", user: { content: "Count from 1 to 5." } } as Message], model: "openai/gpt-4o-mini" });
		const chunks: any[] = [];
